      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <h2 className="text-xl font-semibold mb-3">Milestone-Based Funding</h2>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <h2 className="text-xl font-semibold mb-3">Decentralized Governance</h2>
            <p className="text-gray-600">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="text-4xl mb-4">🎫</div>
            <h2 className="text-xl font-semibold mb-3">Equity Tokenization</h2>
            <p className="text-gray-600">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold mb-4">For Startups</h2>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-white rounded-lg p-6 shadow-md">
              ...
              <p className="text-sm text-gray-600">On-chain reputation system for mentors</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <div className="text-3xl mb-2">📊</div>
              <h3 className="font-semibold mb-2">Transparency</h3>
              <p className="text-sm text-gray-600">All progress recorded on-chain</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <div className="text-3xl mb-2">🎯</div>
              <h3 className="font-semibold mb-2">Staking</h3>
              <p className="text-sm text-gray-600">Community staking pools with rewards</p>
            </div>
            <div className="bg-white rounded-lg p-6 shadow-md">
              <div className="text-3xl mb-2">🌐</div>
              <h3 className="font-semibold mb-2">Global Access</h3>
              <p className="text-sm text-gray-600">No geographic limitations</p>
            </div>
          </div>
        </div>
      </main>
